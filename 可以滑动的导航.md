...
- (void)initialization {
 ...
 _titleLabelSelectedColor = [UIColor colorWithRed:201/255.0 green:78/255.0 blue:60/255.0 alpha:1.0];

 _titleLabelTextFont = [UIFont systemFontOfSize:13];

 _titleLabelBackgroundColor = [UIColor colorWithRed:0/255 green:0/255 blue:0/255 alpha:0.5];
