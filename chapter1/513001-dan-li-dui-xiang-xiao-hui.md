...
-(void)showXLRobot{
    ...
    [self.robotView initiateAnimationWithDuration:XLRobotAnimationDuration];
}

-(XLRobotImageView *)robotView{
    if (!_robotView) {
        _robotView = [XLRobotImageView sharedInstance];
        _robotView.frame = CGRectMake(20, BoundHeight/2 - 115/4, 36, 115/2);
